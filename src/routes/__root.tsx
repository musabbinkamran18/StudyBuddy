...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Study Buddy" },
      { name: "theme-color", content: "#09090b" },
      { title: "Study Buddy" },
      { name: "description", content: "Your adaptive learning companion" },
      { name: "author", content: "Study Buddy" },
      { property: "og:title", content: "Study Buddy" },
      { property: "og:description", content: "Your adaptive learning companion" },
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // demo mode: no Supabase client available, skip auth state listener
    }
